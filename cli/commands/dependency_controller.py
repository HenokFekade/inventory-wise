...
from core.dependencies.{name.lower()}_service import {name.lower()}_service_dep
...
''')
    ...
    import_statement = f"from .{name.lower()}_controller import {name.lower()}_controller_dep\n"
